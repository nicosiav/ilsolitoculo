...
(function () {
  ...
  const S = {
    ...
    cache: {}, sezione: '', pronta: false, mancanti: []
  };
  ...
  function barre(righe) {
    ...
    return `<div class="plist">${righe.map(r => `<div class="prow" style="grid-template-columns:minmax(0,1fr) 84px">
